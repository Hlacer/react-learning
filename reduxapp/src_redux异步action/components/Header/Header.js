...
import {createDecrementAction,createIncrementAction,createDecrementAsyncAction} from '../../redux/count_action' /*引入action专门创建action对象*/
export default class Header extends Component{
    ...
    asyncAdd = () =>{
        const {value} = this.selectNum
        store.dispatch(createDecrementAsyncAction(Number(value),500))
    }
    render() {
        return (
            <div>
